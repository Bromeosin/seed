<?php
/*
 * Template Name: Index-Page-Case Studies
 ...
 get_header(); ?>
  ...
  <div class="row masthead dark hexagons">
    <div class="container">
      <div class="one-half column">
        <h1>Recent projects we've worked on</h1>
        <h4>Our expertise in digital marketing has enabled us to deliver transformative results for our clients.</h4>
      </div>
      <div class="one-half column">
      </div>
    </div>
  ...
  <div class="row quote light grey triangles">
    <div class="container" onload="isotope();">
      ...
      <?php
          // The Query
            query_posts( array ( 'category_name' => 'Case Studies', 'posts_per_page' => 20, 'orderby'=>'latest' ) );
            // The Loop
